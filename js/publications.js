...
// /** ===== NEW: normalize publication type ===== */
...
//     ? `<span class="badge badge--status">${escapeHtml(pub.status)}</span>`
//     : "";
...
//   const badgesHtml =
//     statusBadge || idxBadges || tagBadges
//       ? `<div class="badges">${statusBadge}${idxBadges}${tagBadges}</div>`
//       : "";
...
//             <div class="pub-card__meta-left">${metaLeft}</div>
//             <div class="pub-card__meta-right">${badgesHtml}</div>
//           </div>
...
// /** ===== NEW: filter by type (conference/journal) ===== */
...
//   const typeEl = document.getElementById("pubType"); // ✅ NEW
...
//     typeEl?.addEventListener("change", redraw); // ✅ NEW
